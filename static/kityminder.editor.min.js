 ...
 * ====================================================
 */
function format_pasted(node){
	node["data"]["internal_id"]=""
	node["data"]["priority"]=""
...
!function () {
    var d = {
        r: function (e) {
            if (d[e].inited)
                return d[e].value;
            if ("function" != typeof d[e].value)
                return d[e].inited = !0, d[e].value;
            var t = {
                exports: {}
            },
            n = d[e].value(null, t.exports, t);
            if (d[e].inited = !0, void 0 !== (d[e].value = n))
                return n;
            for (var i in t.exports)
                if (t.exports.hasOwnProperty(i))
                    return d[e].inited = !0, d[e].value = t.exports, t.exports
        }
    };
    d[0] = {
        value: function (e, t, n) {
            ...
            function o(e) {
                ...
                for (var t = 0; t < i.length; t++)
                    "function" == typeof i[t] && i[t].call(this, this)
            }
                                ...
                                if ("application/km" === s.whichMimeType(i)) {
                                    ...
                                    r.forEach(function (e) {
                                        for (var t = a.length - 1; 0 <= t; t--)
                                            o = c.createNode(null, e), c.importNode(o, a[t]), p.push(o), e.appendChild(o)
                                    }),
                                    c.select(p, !0),
                                    p = [],
                                    c.refresh()
    ...
    d[7] = {
        value: function (e, t, n) {
            return n.exports = function () {
                var e;
                if (!(e = "string" == typeof this.selector ? document.querySelector(this.selector) : this.selector))
    ...
    d[8] = {
        value: function (e, t, n) {
            ...
            return n.exports = function () {
                ...
                t.when("* -> drag", function () {}),
                t.when("drag -> *", function (e, t, n) {});
                var a,
                l,
                s,
                c,
                ...
                function f(e, t) {
                    if (!e)
                        return p = g = !1, u && kity.releaseFrame(u), void(u = null);
                    var n,
                    i,
                    r;
                    u || (u = kity.requestFrame((n = e, i = t, r = o, function (e) {
                                    switch (n) {
                                    case "left":
                                        r._viewDragger.move({
                                            x: -i,
                ...
                this.fsm = new function (e) {
                    ...
                    this.jump = function (e, t) {
                        ...
                        for (n = 0; n < l.length; n++)
                            if (c((i = l[n]).condition, "before", r, e) && i.apply(null, o))
                                return;
                        for (a = e, s.log("[{0}] {1} -> {2}", t, r, e), n = 0; n < l.length; n++)
                            c((i = l[n]).condition, "after", r, e) && i.apply(null, o);
                        return a
                    },
                    this.state = function () {
                        return a
                    ...
                    this.when = function (e, t) {
                        ...
                        r,
                        o;
                        if (1 == arguments.length && (t = e, e = "* -> *"), 2 == (i = e.split(" - ")).length ? n = "before" : 2 == (i = e.split(" -> ")).length && (n = "after"), !n)
                            throw new Error("Illegal fsm condition: " + e);
                        r = i[0],
                        o = i[1],
                        t.condition = {
                            when: n,
    ...
    d[11] = {
        value: function (e, t, n) {
            ...
            return n.exports = function () {
                ...
                l = new i(t);
                l.setParentFSM(e),
                e.when("normal -> hotbox", function (e, t, n) {
                    var i,
                    r = a.getSelectedNode();
                    if (r) {
                ...
                e.when("normal -> normal", function (e, t, n, i) {
                    "shortcut-handle" == n && (l.dispatch(i) ? i.preventDefault() : a.dispatchKeyEvent(i))
                }),
                e.when("modal -> normal", function (e, t, n, i) {
    ...
    d[12] = {
        value: function (e, t, n) {
            ...
            return n.exports = function () {
                ...
                p.on("layoutallfinish viewchange viewchanged selectionchange", function (e) {
                    "viewchange" == e.type && "input" != r.state() || i()
                }),
                i(),
                r.when("* -> input", n),
                r.when("input -> *", function (e, t, n) {
                    switch (n) {
                    case "input-cancel":
                        return g();
                    case "input-commit":
                    default:
                        return function () {
                            ...
                            if (e = function (e) {
                                for (var t, n, i, r = "", o = /\S/, a = new RegExp("( |" + String.fromCharCode(160) + ")"), l = document.createElement("br"), s = !1, c = !1, d = 0, u = e.length; d < u; d++)
                                    switch (t = e[d], Object.prototype.toString.call(t)) {
                                    case "[object HTMLBRElement]":
                                        r += "\n";
                                        break;
                                    case "[object Text]":
                                        if (t = t.textContent.replace("&nbsp;", " "), o.test(t))
                                            r += t;
                                        else
                                            for (i = t.length; i--; )
                                                a.test(t[i])
                                        ...
                                        case "[object HTMLDivElement]":
                                            n = [];
                                            for (var m = 0, u = t.childNodes.length; m < u; m++)
                                                n.push(t.childNodes[m]);
                                            n.push(l),
                                        ...
                                        default:
                                            if (t && t.childNodes.length) {
                                                ...
                                                t && void 0 !== t.textContent ? r += t.textContent : r += ""
                                        }
                                    ...
                                    try {
                                        ...
                                        if (p.fire("contentchange"), p.getRoot().renderTree(), "Error: Invalid local format" !== e.toString())
                                            throw e
                                    }
                                }
                                    (t, e), "root" == t.type) {
    ...
    d[13] = {
        value: function (e, t, n) {
            ...
            return n.exports = function () {
                ...
                l = this.hotbox,
                s = !1;
                o.listen("normal", function (e) {
                    if (o.enable(), e.is("Space"))
                        return e.preventDefault(), kity.Browser.safari && (a.innerHTML = ""), i.jump("hotbox", "space-trigger");
                    switch (e.type) {
                    case "keydown":
                        if (r.getSelectedNode()) {
                            if (!((t = e).ctrlKey || t.metaKey || t.altKey) && (65 <= t.keyCode && t.keyCode <= 90 || 48 <= t.keyCode && t.keyCode <= 57 || 108 != t.keyCode && 96 <= t.keyCode && t.keyCode <= 111 || 108 != t.keyCode && 96 <= t.keyCode && t.keyCode <= 111 || 229 == t.keyCode || 0 === t.keyCode))
                                return i.jump("input", "user-input")
                        } else
                            a.innerHTML = "";
                ...
                o.listen("hotbox", function (e) {
                    if (o.disable(), e.preventDefault(), l.dispatch(e), l.state() == c.STATE_IDLE && "hotbox" == i.state())
                        return i.jump("normal", "hotbox-idle")
                }),
                o.listen("input", function (e) {
                    if (o.enable(), "keydown" == e.type) {
                        if (e.is("Enter"))
                            return e.preventDefault(), i.jump("normal", "input-commit");
                        if (e.is("Esc"))
                            return e.preventDefault(), i.jump("normal", "input-cancel");
                        (e.is("Tab") || e.is("Shift + Tab")) && e.preventDefault()
                    } else if ("keyup" == e.type && e.is("Esc")) {
                        if (e.preventDefault(), !s)
                            return i.jump("normal", "input-cancel")
                    } else
                        "compositionstart" == e.type ? s = !0 : "compositionend" == e.type && setTimeout(function () {
                                s = !1
                            })
                }),
                ...
                l.$element.addEventListener("mousedown", function (e) {
                    e.stopPropagation()
                })
            }
        }
    ...
    d[15] = {
        value: function (e, t, n) {
            return n.exports = function () {
                ...
                s = e.state("main"),
                c = 0;
                ["前移:Alt+Up:ArrangeUp", "下级:Tab|Insert:AppendChildNode", "同级:Enter:AppendSiblingNode", "后移:Alt+Down:ArrangeDown", "删除:Delete|Backspace:RemoveNode", "上级:Shift+Tab|Shift+Insert:AppendParentNode"].forEach(function (e) {
                    var t = e.split(":"),
                    n = t.shift(),
                    i = t.shift(),
                    r = t.shift();
                    s.button({
                        ...
                        key: i,
                        action: function () {
                            0 === r.indexOf("Append") ? (c++, a.execCommand(r, "分支主题"), a.on("layoutallfinish", function e() {
                                    --c || o.editText(),
    ...
    d[16] = {
        value: function (e, t, n) {
            return n.exports = function () {
                ...
                "123456789".replace(/./g, function (e) {
                    n.button({
                        position: "ring",
                        label: "P" + e,
                        key: e,
    ...
    d[17] = {
        value: function (e, t, n) {
            return n.exports = function () {
                ...
                "012345678".replace(/./g, function (e) {
                    n.button({
                        position: "ring",
                        label: "G" + e,
                        key: e,
            ...
            return n.exports = function () {
                ...
                function o(e) {
                    ...
                    for (var n = 0; n < r.length; n++)
                        if (("*" == (t = r[n]).notifyState || t.notifyState == i.state()) && t.call(null, e))
                            return
                }
    ...
    d[20] = {
        value: function (e, t, n) {
            return n.exports = function (e, n) {
                ...
                String(e).replace(/\{(\w+)\}/gi, function (e, t) {
                    return n[t] || t
                })
            }
        }
    ...
    d[21] = {
        value: function (e, t, n) {
            !("innerText" in document.createElement("a")) && "getSelection" in window && (HTMLElement.prototype.__defineGetter__("innerText", function () {
                    ...
                    i = [];
                    for (t = 0; t < n.rangeCount; t++)
                        i[t] = n.getRangeAt(t);
                    for (n.removeAllRanges(), n.selectAllChildren(this), e = n.toString(), n.removeAllRanges(), t = 0; t < i.length; t++)
                        n.addRange(i[t]);
                    return e
        ...
        value: function (e, t, n) {
            ...
            function l(e) {
                return "string" == typeof e ? (t = 0, e.toLowerCase().split(/\s*\+\s*/).forEach(function (e) {
                    ...
                    var t = 0;
                    (e.ctrlKey || e.metaKey) && (t |= r);
                    e.altKey && (t |= o);
                    e.shiftKey && (t |= a);
                    if (-1 === [16, 17, 18, 91].indexOf(e.keyCode)) {
                        if (229 === e.keyCode && e.keyIdentifier)
                            return t |= parseInt(e.keyIdentifier.substr(2), 16);
                        t |= e.keyCode
                    }
                    return t
                }
    ...
    d[24] = {
        value: function (e, t, n) {
            ...
            for (var r in i)
                i.hasOwnProperty(r) && (i[r.toLowerCase()] = i[r]);
    ...
    angular.module("kityminderEditor", ["ui.bootstrap", "ui.codemirror", "ui.colorpicker"]).config(["$sceDelegateProvider", function (e) {
    ...
    angular.module("kityminderEditor").run(["$templateCache", function (e) {
                "use strict";
    ...
    angular.module("kityminderEditor").provider("config", function () {
        ...
        this.set = function (e, t) {
            ...
            for (var r in "object" == typeof e ? i = e : i[e] = t, i) {
                if (!i.hasOwnProperty(r) || -1 === n.indexOf(r))
                    return console.error("Unsupported config key: ", e, ", please choose in :", n.join(", ")), !1;
                this.config[r] = i[r]
            }
            return !0
        },
    ...
    angular.module("kityminderEditor").service("resourceService", ["$document", function (t) {
                var n = null;
    ...
    angular.module("kityminderEditor").service("revokeDialog", ["$modal", "minder.service", function (e, t) {
                return t.registerEvent(function () {
                    var t = window.minder,
                    n = window.editor,
                    i = n.hotbox.getParentFSM();
                    t.on("importNodeData", function () {
    ...
    angular.module("kityminderEditor").service("server", ["config", "$http", function (i, r) {
                return {
    ...
    angular.module("kityminderEditor").filter("lang", ["config", "lang.zh-cn", function (r, o) {
                return function (e, t) {
    ...
    angular.module("kityminderEditor").controller("hyperlink.ctrl", ["$scope", "$modalInstance", "link", function (t, n, e) {
    ...
    angular.module("kityminderEditor").controller("imExportNode.ctrl", ["$scope", "$modalInstance", "title", "defaultValue", "type", function (r, e, t, n, o) {
                r.title = t,
                r.value = n,
                r.type = o,
                r.ok = function () {
    ...
    angular.module("kityminderEditor").controller("image.ctrl", ["$http", "$scope", "$modalInstance", "image", "server", function (i, r, t, e, n) {
                r.data = {
                    list: [],
                    url: e.url || "",
                    title: e.title || "",
                ...
                r.ok = function () {
                    if (r.data.R_URL.test(r.data.url))
                        t.close({
                            url: r.data.url,
                            title: r.data.title
                        });
    ...
    angular.module("kityminderEditor").directive("appendNode", ["commandBinder", function (t) {
                return {
                    restrict: "E",
    ...
    angular.module("kityminderEditor").directive("arrange", ["commandBinder", function (e) {
                return {
                    restrict: "E",
    ...
    angular.module("kityminderEditor").directive("hyperLink", ["$modal", function (n) {
                return {
                    restrict: "E",
    ...
    angular.module("kityminderEditor").directive("imageBtn", ["$modal", function (n) {
                return {
                    restrict: "E",
    ...
    angular.module("kityminderEditor").directive("kityminderEditor", ["config", "minder.service", "revokeDialog", function (a, l, e) {
                return {
                    restrict: "EA",
                    ...
                    link: function (i, e, t) {
                        ...
                        if ("undefined" != typeof seajs)
                            seajs.config({
                                ...
                                n.minder.on("contentchange", function () {
    ...
    angular.module("kityminderEditor").directive("kityminderViewer", ["config", "minder.service", function (e, l) {
                return {
                    restrict: "EA",
    ...
    angular.module("kityminderEditor").directive("navigator", ["memory", "config", function (g, f) {
                return {
                    restrict: "A",
    ...
    angular.module("kityminderEditor").directive("noteBtn", ["valueTransfer", function (t) {
                return {
                    restrict: "E",
    ...
    angular.module("kityminderEditor").directive("noteEditor", ["valueTransfer", function (a) {
                return {
                    restrict: "A",
                    ...
                    controller: ["$scope", function (n) {
                            ...
                            n.$watch("noteContent", function (e) {
    ...
    angular.module("kityminderEditor").directive("notePreviewer", ["$sce", "valueTransfer", function (v, e) {
                return {
                    restrict: "A",
                    ...
                    link: function (m, e) {
                        ...
                        n.on("shownoterequest", function (e) {
                        ...
                        e.on("mousedown mousewheel DOMMouseScroll", function (e) {
                            e.stopPropagation()
                        })
                    }
                }
    ...
    angular.module("kityminderEditor").directive("priorityEditor", ["commandBinder", function (r) {
                return {
                    restrict: "E",
                    ...
                    replace: !0,
                    link: function (e) {
                        for (var t = e.minder, n = [], i = 0; i < 10; i++)
                            n.push(i);
                        r.bind(t, "priority", e),
                        e.priorities = n,
    ...
    angular.module("kityminderEditor").directive("progressEditor", ["commandBinder", function (r) {
                return {
                    restrict: "E",
    ...
    }).directive("clickAnywhereButHere", ["$document", function (o) {
                return {
                    link: function (i, e, r) {
                        var n = function (e) {
                        ...
                        i.$watch(r.isActive, function (e, t) {
            ...
            controller: ["$scope", function (a) {
                    ...
                    function d(e, t) {
                        if (a.showTip = !1, l.fire("hidenoterequest"), e && /\S/.exec(e)) {
                            ...
                            i,
                            r = d.lastKeyword != e;
                            if (d.lastKeyword = e, r && function (e) {
                                c = [];
                                for (var t = 0; t < s.length; t++) {
                                    var n = s[t];
                                    -1 != n.getText().toLowerCase().indexOf(e) && c.push({
                                        node: n
                                    });
                ...
                e.select = {
                    ...
                    siblings: function () {
                        ...
                        e.forEach(function (e) {
                            e.parent && e.parent.children.forEach(function (e) {
                    ...
                    level: function () {
                        ...
                        n = [];
                        i.getRoot().traverse(function (e) {
                            -1 != t.indexOf(e.getLevel()) && n.push(e)
                        }),
                        i.select(n, !0),
                        i.fire("receiverfocus")
                    },
